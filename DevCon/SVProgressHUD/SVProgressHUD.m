...
+ (void)show {
    [[SVProgressHUD appearance] setHudBackgroundColor:[[UIColor darkGrayColor] colorWithAlphaComponent:0.4]];
    //[[SVProgressHUD appearance] setHudRingBackgroundColor:[[UIColor greenColor] colorWithAlphaComponent:0.4]];
